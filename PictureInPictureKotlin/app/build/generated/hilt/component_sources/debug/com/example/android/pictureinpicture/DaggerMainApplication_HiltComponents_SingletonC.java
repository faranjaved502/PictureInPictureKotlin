...
import com.example.android.pictureinpicture.di.AppModule_ProvideTimerRepositoryFactory;
import com.example.android.pictureinpicture.di.UseCaseModule;
import com.example.android.pictureinpicture.di.UseCaseModule_ProvideSystemClockFactory;
...
public final class DaggerMainApplication_HiltComponents_SingletonC {
  ...
  public static final class Builder {
    ...
    public MainApplication_HiltComponents.SingletonC build() {
      ...
      return new SingletonCImpl(appModule, useCaseModule);
    }
  }
  ...
  private static final class ViewModelCImpl extends MainApplication_HiltComponents.ViewModelC {
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.example.android.pictureinpicture.MainViewModel", ((Provider) mainViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.android.pictureinpicture.MainViewModel 
          return (T) new MainViewModel(singletonCImpl.provideSystemClockProvider.get(), singletonCImpl.provideTimerRepositoryProvider.get());
  ...
  private static final class SingletonCImpl extends MainApplication_HiltComponents.SingletonC {
    ...
    private Provider<SystemClockWrapper> provideSystemClockProvider;

    private Provider<TimerRepository> provideTimerRepositoryProvider;

    private SingletonCImpl(AppModule appModuleParam, UseCaseModule useCaseModuleParam) {
      this.useCaseModule = useCaseModuleParam;
      this.appModule = appModuleParam;
      initialize(appModuleParam, useCaseModuleParam);
    ...
    private void initialize(final AppModule appModuleParam,
      ...
      this.provideSystemClockProvider = DoubleCheck.provider(new SwitchingProvider<SystemClockWrapper>(singletonCImpl, 0));
      this.provideTimerRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<TimerRepository>(singletonCImpl, 1));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.android.pictureinpicture.usecase.SystemClockWrapper 
          return (T) UseCaseModule_ProvideSystemClockFactory.provideSystemClock(singletonCImpl.useCaseModule);

          case 1: // com.example.android.pictureinpicture.repository.TimerRepository 
          return (T) AppModule_ProvideTimerRepositoryFactory.provideTimerRepository(singletonCImpl.appModule);
