...
class MainViewModel @Inject constructor(
    ...
    var startUptimeMillis = systemClockWrapper.uptimeMillis()
    var timeMillis = timerRepository.getTime()
    private val _started = timerRepository.started()
    ...
    private suspend fun CoroutineScope.start() {
        startUptimeMillis = systemClockWrapper.uptimeMillis() - (timeMillis.value ?: 0L)
        while (isActive) {
            timeMillis.value = systemClockWrapper.uptimeMillis() - startUptimeMillis
     ...
     */
    fun clear() {
        startUptimeMillis = systemClockWrapper.uptimeMillis()
